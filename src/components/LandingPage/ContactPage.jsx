      ...
      <div className="max-w-5xl w-full space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="glassmorphism bg-white/50 backdrop-blur-md shadow-lg rounded-3xl p-8 text-center">
              ...
              <MapContainer center={[27.691392576164542, 84.44414394023492]} zoom={13} zoomControl={false} style={{ height: '250px', width: '100%', borderRadius: '1.5rem' }}>
                <TileLayer
                  url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                  attribution='&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
                />
                <Marker
                  position={[27.691392576164542, 84.44414394023492]}
                  icon={customIcon}
                >
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-8">
            <a href="#" className="text-gray-600 hover:text-[#1877F2] transition-transform duration-300 ease-out hover:scale-110">
            ...
            <a href="#" className="text-gray-600 hover:text-[#1DA1F2] transition-transform duration-300 ease-out hover:scale-110">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
